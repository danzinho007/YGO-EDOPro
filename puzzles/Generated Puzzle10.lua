...
--Hand (yours) mão do jogador
Debug.AddCard(23558733,0,0,LOCATION_HAND,0,POS_FACEDOWN)
Debug.AddCard(96553688,0,0,LOCATION_HAND,0,POS_FACEDOWN)
Debug.AddCard(85431040,0,0,LOCATION_HAND,0,POS_FACEDOWN)
Debug.AddCard(43422537,0,0,LOCATION_HAND,0,POS_FACEDOWN)

--GY (yours)
Debug.AddCard(54112932,0,0,LOCATION_GRAVE,0,POS_FACEUP)
Debug.AddCard(54112932,0,0,LOCATION_GRAVE,0,POS_FACEUP)
Debug.AddCard(54112932,0,0,LOCATION_GRAVE,0,POS_FACEUP)
Debug.AddCard(54112932,0,0,LOCATION_GRAVE,0,POS_FACEUP)
Debug.AddCard(54112932,0,0,LOCATION_GRAVE,0,POS_FACEUP)
...
--Monster Zones (yours)
Debug.AddCard(99000151,0,0,LOCATION_MZONE,2,POS_FACEUP_ATTACK,true)
--Debug.AddCard(96553688,0,0,LOCATION_MZONE,3,POS_FACEDOWN_ATTACK,true)
Debug.AddCard(96553688,0,0,LOCATION_MZONE,4,POS_FACEUP_DEFENSE,true)
